...
python retrieval/index.py --ckpt_path my_files/saved_checkpoints/retriever_random.ckpt --corpus-path data/leandojo_benchmark_4/corpus.jsonl --output-path my_files/indexed_corpora/random_indexed_corpus.pkl
