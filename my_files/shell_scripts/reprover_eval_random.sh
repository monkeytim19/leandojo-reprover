...
python prover/evaluate.py --data-path data/leandojo_benchmark_4/random/  --ckpt_path my_files/saved_checkpoints/reprover_random.ckpt --indexed-corpus-path PATH_TO_INDEXED_CORPUS --split test --num-cpus 8 --with-gpus
