...
python prover/evaluate.py --data-path data/leandojo_benchmark_4/novel_premises/ --ckpt_path my_files/saved_checkpoints/generator_novel_premises.ckpt --split test --num-workers 2 --num-gpus 1
